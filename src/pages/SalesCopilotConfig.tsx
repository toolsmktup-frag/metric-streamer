  ...
  return (
    <div className="space-y-4 max-w-4xl">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">Copiloto de Vendas — Script</h1>
      </div>
      <p className="text-sm text-muted-foreground">
        Esse script é o cérebro do Copiloto. Quanto mais detalhado e específico, melhores serão as sugestões para os vendedores.
        Inclua tom de voz, etapas do funil, objeções comuns, produtos, valores e o que NÃO deve ser dito.
      </p>
