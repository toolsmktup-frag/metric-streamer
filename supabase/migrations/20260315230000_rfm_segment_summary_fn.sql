-- ═══════════════════════════════════════════════════════════════════
-- FUNÇÃO: fn_rfm_segment_summary()
--
-- Retorna uma linha por segmento RFM com estatísticas agregadas.
-- Usa NTILE(5) para scoring de R, F, M — mesma lógica do frontend.
-- Utilizada pelo Agente IA para contexto de inteligência de clientes.
--
-- ROLLBACK: DROP FUNCTION public.fn_rfm_segment_summary();
-- ═══════════════════════════════════════════════════════════════════
...
COMMENT ON FUNCTION public.fn_rfm_segment_summary() IS
  ...
  'Usa NTILE(5) para scoring R/F/M. Usada pelo Agente IA como contexto.';
