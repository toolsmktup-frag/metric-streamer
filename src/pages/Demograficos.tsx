...
export default function Demograficos() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-foreground">Demográficos</h1>

      {noData && (
        <div className="rounded-lg border border-border bg-card p-6 text-center text-sm text-muted-foreground">
          Nenhum dado demográfico encontrado. Sincronize os dados do Meta Ads.
        </div>
      )}

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-lg border border-border bg-card p-4">
          <h3 className="text-sm font-semibold text-foreground mb-4">Gasto por Faixa Etária</h3>
          {ageData.length > 0 ? (
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          <h3 className="text-sm font-semibold text-foreground mb-4">Gasto por Gênero</h3>
          {genderData.length > 0 ? (
